...
==> ORA-01950: no privileges on tablespace 'SYSTEM' 에러발생 
...
conn system/oracle
alter user miller quota unlimited on system; --(메모리 할당 무제한)
...
COMMIT;
------------------------------
STORM이 SCOTT.EMP 테이블을 SELECT하는 권한을 MILLER에게 부여해본다.
