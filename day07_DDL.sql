...
- unique한 값 + not null
    ...
    insert into test_tab1 values(2, '홍길동', null);
...
create table nn_tab(
    ...
    dname varchar(20) constraint nn_tab_dname_nn not null,
...
INSERT INTO CK_TAB2 VALUES (30, 'SALES', 'SEOUL');
...
# 컬럼 추가/변경/삭제
    ...
    - ALTER TABLE 테이블명 RENAME COLUMN OLD컬렴명 TO NEW컬럼명
...
--[5] NAME컬럼을 삭제하세요
ALTER TABLE BOARD_TAB DROP NAME;
...
- DROP TABLE 테이블명 PURGE; --찌꺼기 데이터까지 모두 삭제
